...
<body>
    ...
    <main>
        <div class="center mt-16">
            ...
            <div style="display: flex; align-items: center; justify-content: center;">
                <div class="container">
                <h1 id="title-header">Home Page</h1>
                    <?php 
                        $acc_id = '';
                        $full_name = '';
                        if($_GET["acc_id"]){
                        ...
                        WHERE tp.posted_privacy = 1 AND tp.post_status = 1 AND ta.acc_id = ?
    ...
    <input type="text" value="<?php echo $full_name ?>" id="full_name" hidden>
...
<script>
    ...
    titleHeader.innerHTML = `${full_name}'s News Feed`;
</script>
</body>
</html>
