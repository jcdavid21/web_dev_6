    ...
    <div id="visibility-modal" tabindex="-1" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="relative w-full max-w-md bg-white rounded-lg shadow-lg dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Select Post Visibility</h3>
            ...
            <div class="p-4 space-y-3">
                <button type="button" onclick="setVisibility('Public')" class="w-full px-4 py-2 text-left text-gray-900 font-medium rounded-lg hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">Public</button>
                <button type="button" onclick="setVisibility('Private')" class="w-full px-4 py-2 text-left text-gray-900 font-medium rounded-lg hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">Private</button>
                <button type="button" onclick="setVisibility('Only Me')" class="w-full px-4 py-2 text-left text-gray-900 font-medium rounded-lg hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">Only Me</button>
            </div>
            <!-- Modal footer -->
            <div class="flex justify-end p-4 border-t border-gray-200 dark:border-gray-600">
                ...
                <button onclick="closeModal()" class="ms-3 text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700">Cancel</button>
            </div>
        </div>
    </div>
